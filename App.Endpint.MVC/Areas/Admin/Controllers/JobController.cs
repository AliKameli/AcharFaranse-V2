...
public class JobController : Controller
{
    ...
    {
        ViewData["Costumers"] =
            new List<CostumerDto>(await _costumerAppService.GetByCityIdAsync((int) TempData.Peek("cityId")!));
    ...
    {
        ViewData["CostumerAddresses"] =
            new List<CostumerAddressDto>(await _costumerAddressAppService.GetByCostumerIdAsync(costumerId));
    ...
    public async Task<ActionResult> Edit(int id)
    {
        var model = await _jobAppService.GetByIdAsync(id);
        ViewData["CostumerAddresses"] =
            new List<CostumerAddressDto>(await _costumerAddressAppService.GetByCostumerIdAsync(model.CostumerId));
        ViewData["JobCategories"] = new List<JobCategoryDto>(await _jobCategoryAppService.GetAllAsync());
